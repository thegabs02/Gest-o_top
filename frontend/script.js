...
for (let resultado of resultados) {
    ...
    botao.addEventListener("click", () => {
        ...
        const busca_texto = botao.textContent;
        return busca_texto;
    });
...
const busca_texto = document.getElementById("busca").value;
const tot_serv = document.getElementById("tot_serv").textContent;
